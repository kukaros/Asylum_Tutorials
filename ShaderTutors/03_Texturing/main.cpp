...
#define TITLE		"Shader tutorial 3: Texturing"
...
HRESULT InitScene()
{
	...
	if( FAILED(hr = CreateChecker(device, 10, 10, 0xffffffff, 0xff000000, &texture)) )
	{
	...
	hr = D3DXCreateEffectFromFileA(device, "../media/shaders/textured.fx", NULL, NULL, D3DXSHADER_DEBUG, NULL, &effect, &errors);
