...
void AnimatedMesh::GenerateSkinnedMesh(D3DXMESHCONTAINER_EXTENDED* meshContainer)
{
	if( Method == SM_Shader )
	{
		...
		// some cards can't handle ubyte4
		pDeclCur = pDecl;
...
void AnimatedMesh::CloneMeshContainer(LPD3DXMESHCONTAINER from, LPD3DXMESHCONTAINER* to)
{
...
HRESULT AnimatedMesh::Clone(AnimatedMesh& to)
{
	to.Method			= Method;
	to.Path				= Path;
	to.Effect			= Effect;
